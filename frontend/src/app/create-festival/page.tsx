...
export default function CreateFestivalPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!token) {
      setError('Please log in to create a festival');
      setLoading(false);
      return;
    }
    ...
    return (
      <div style={{ minHeight: '100vh', backgroundColor: 'var(--background-color)' }}>
        ...
        <div style={{ 
          ...
          <p style={{ color: '#dc2626' }}>Please log in to create a festival</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div style={{ minHeight: '100vh', backgroundColor: 'var(--background-color)' }}>
        ...
        <div style={{ 
          ...
          <p style={{ color: '#dc2626' }}>Access Denied: Admin privileges required to create festivals</p>
        </div>
      </div>
    );
  }
